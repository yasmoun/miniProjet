...
public class chefController {
	 @FXML
	    ...
	    @FXML
	    void handleDepartementClick(MouseEvent event) {
	        Stage stage = (Stage) departement.getScene().getWindow();
	        stage.close();
	        
	        try {
	            FXMLLoader loader = new FXMLLoader(getClass().getResource("chefDep.fxml"));
	            Stage loginStage = new Stage();
	            loginStage.setScene(new Scene(loader.load()));
	            loginStage.show();
	        } catch (IOException e) {
